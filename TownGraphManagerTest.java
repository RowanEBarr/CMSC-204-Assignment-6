...
public class TownGraphManagerTest {
	...
	public void setUp() throws Exception {
		  ...
		  graph.addRoad(town[1], town[2], 2, "Road_1"); //0
		  graph.addRoad(town[1], town[3], 4, "Road_2"); //1
		  graph.addRoad(town[1], town[5], 6, "Road_3"); //2
		  graph.addRoad(town[3], town[7], 1, "Road_4"); //3
		  graph.addRoad(town[3], town[8], 2, "Road_5"); //4
